...
CREATE TABLE RapportVisite (
  ...
  rap_coeff_confiance int(1) NOT NULL CHECK (rap_coeff>=5 AND rap_coeff<=0),
  mot_id int(11) NOT NULL,
  PRIMARY KEY (vis_matricule,rap_num,mot_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO RapportVisite VALUES
	( 'a131' , 1 , '2018-03-01' , 'RAS' , 22 , '2018-03-02' , 4 , 1 ) ,
	( 'a131' , 2 , '2018-04-02' , 'RAS' , 22 , '2018-04-03' , 5 , 2 ) , 
	( 'a131' , 3 , '2018-04-03' , 'RAS' , 18 , '2018-04-04' , 4 , 3 ) ,
	( 'a131' , 4 , '2018-05-10' , 'RAS' , 22 , '2018-05-10' , 3 , 4 ) ,
	( 'a131' , 5 , '2018-05-21' , 'RAS' , 18 , '2018-05-21' , 2 , 5 ) ;
	
CREATE TABLE Motif (
  mot_id int(11) NOT NULL AUTO_INCREMENT,
  mot_libelle varchar(60) NOT NULL,
  mot_precision varchar(60) NOT NULL,
  rap_num int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (mot_id,rap_num)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE Visiteur (
  ...
  vis_mdp varchar(60) DEFAULT NULL,
  sec_code varchar(2) DEFAULT NULL,
...
ALTER TABLE Motif ADD CONSTRAINT  FK_MOTIF_RAPPORT_VISITE FOREIGN KEY(rap_num) REFERENCES RapportVisite(rap_num) ;
